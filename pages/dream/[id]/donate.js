...
export default function Example() {
  ...
  const getNFT = async () => {
    try {
      ...
      toast.success("benefits obtained");
      ...
      setStatusText("Successful Minting, signing NFT.");
      toast.success("Successful Minting, signing NFT.");
  ...
  const signNFT = async (nft) => {
    try {
      ...
      console.log(result);
      toast.success("Transaction sent and NFT received 👏");
      ...
      setStatusText(
        `Successfully signed NFT https://solscan.io/tx/${result.data.result}?cluster=devnet`
      );
    } catch (error) {
      console.log(error);
    }
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <p className="mt-6 text-base leading-7 text-gray-600">
                You are free to donate any amount you wish. Your donation will
          ...
          <div className="p-10">
            <p className=" mt-2 text-lg leading-8 text-gray-600">
              When making a donation with Solana, you are making a voluntary
            ...
            <p className=" mt-2 text-lg leading-8 text-gray-600">
              We utilize Solana's blockchain technology to ensure the security
              and transparency of your donations. Transactions with Solana are
              fast and secure, providing you with peace of mind when making your
              contribution.
            </p>
          </div>
        </div>
