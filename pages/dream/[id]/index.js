              ...
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                ...
                <div className="border-t border-gray-200 px-4 py-6">
                  <a href="#" className="-m-2 flex items-center p-2">
                    <Image
                      src="https://res.cloudinary.com/dzdqwcqj0/image/upload/v1685750833/DreamBacker/1_yxfrkb.png"
                      alt=""
              ...
              <div className="flex flex-col-reverse">
                <div className="mt-4">
                  ...
                  <p className="mt-2 text-sm text-white">
                    Activa {product.version.name} (Última actualización{" "}
              ...
              <div className="mt-10 border-t border-gray-200 pt-10">
                ...
                <ul role="list" className="mt-4 flex items-center space-x-6">
                  <li>
                    <a
                      href="#"
                      className="flex h-6 w-6 items-center justify-center text-white hover:text-white"
                    >
              ...
              <Tab.Group as="div">
                ...
                <Tab.Panels as={Fragment}>
                  <Tab.Panel className="-mb-10">
                    <h3 className="sr-only">Backers</h3>
                  ...
                  <Tab.Panel className="text-sm text-white">
                    <h3 className="sr-only">Frequently Asked Questions</h3>

                    <dl>
                      {faqs.map((faq) => (
                        <Fragment key={faq.question}>
                          <dt className="mt-10 font-medium text-white">
                            {faq.question}
                          </dt>
                          <dd className="prose prose-sm mt-2 max-w-none text-white">
                            <p>{faq.answer}</p>
                          </dd>
                        </Fragment>
                      ))}
