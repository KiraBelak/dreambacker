...
const portfolio_endpoint = "https://api.shyft.to/sol/v1/wallet/get_portfolio?network=devnet&wallet="
    ...
    switch (method) {
        case "GET":
            try{
                ...
                const dreamExistsInNFTs = nfts.some(nft => nft.name == dreamObj.title);
